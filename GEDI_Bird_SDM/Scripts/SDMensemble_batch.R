...
## describe the script function's batch call arguments
option_list = list(
		...
		make_option(c("-b", "--balancePA"), action="store", default="Bal", type="character", help="balance presence/absence data for training? Use NoBal, Bal, varA, or stratPA. Defaults to NoBal", dest="bal"),
