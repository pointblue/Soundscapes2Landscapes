...
roidata<-subset(roidf,vote=="present")
...
tpMatchesList<-getROItruepos(allnproidata=roidata,roipreds=roipreds,dataSource=dataSource,getROItpMatch=getROItpMatch,removeDoubleFP=removeDoubleFP)

## Save the results and later add to the roi analyses on the test set
save(tpMatchesList,file=paste0(pathToLocalGit,"GVanalyses/3models2outputs/data/TPmatches_list_preTrained_06142021.RData"))
...
## Save the results and later add to the roi analyses on the test set
save(tpMatchesList,file=paste0(pathToLocalGit,"GVanalyses/3models2outputs/data/TPmatches_list_not_preTrained_06142021.RData"))
