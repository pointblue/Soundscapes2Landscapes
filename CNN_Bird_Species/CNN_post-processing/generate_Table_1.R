...
## This code generates Table 1 of the ms.

libs<-c("ggplot2","plyr","RMySQL","data.table","reticulate","dplyr","rminer")
lapply(libs, require, character.only = TRUE)

pathToLocalGit<-"c:/users/lsalas/git/Soundscapes2Landscapes/CNN_Bird_Species/CNN_post-processing/"  # change to your cloned repo path
...
load(file=paste0(pathToLocalGit,"data/gvData_20210518.RData"))
...
roidf<-read.csv(paste0(pathToLocalGit,"data/pattern_matching_ROIs_centers_210510.csv"), 
